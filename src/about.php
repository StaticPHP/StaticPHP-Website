...
<p>With the addition of the <a href="https://docs.staticphp.io/metadata" target="_blank">MetaData</a> feature and support for <a href="https://docs.staticphp.io/html-files" target="_blank">HTML files</a>, you can now develop your site without writing any PHP code or creating any <a href="https://docs.staticphp.io/php-files" target="_blank">PHP files</a> if you don't want to.
<p>You can set Friendly URLs to true in your build configuration to have the output be an <code>index.html</code> file placed inside a folder with the same name as the input file minus the extension. This lets you have urls such as <code>domain.tld/page</code> instead of <code>domain.tld/page.html</code>. This setting can be overridden on a per-page basis by setting the boolean variable <code>$friendly_urls</code> or the Special <a href="https://docs.staticphp.io/metadata" target="_blank">MetaData</a> key <code>friendly_urls</code> to true to enable it or false to disable it.</p>
